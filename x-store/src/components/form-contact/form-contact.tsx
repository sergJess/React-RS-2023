...
export const FormContact = (props: TFormContactProps) => {
  ...
  return (
    <form className="form-contact" ref={form}>
      ...
      <button className="form-contact__submit">Create card</button>
      <div className={state.isDataOk ? 'form-ok' : 'form-ok form-ok_invisible'}>
        Your data has been safed
        <button className="form-ok__btn">Ok</button>
      </div>
    </form>
  );
};
export class FormContactX extends React.Component<TFormContactProps, TFormContactState> {
